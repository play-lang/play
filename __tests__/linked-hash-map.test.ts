...
describe("linked hash map", () => {
	...
	it("should maintain insertion ordinal", () => {
	...
	it("should adjust ordinals after delete", () => {
		const map = new LinkedHashMap<number, string>();
		map.set(1, "a");
		map.set(2, "b");
		map.set(3, "c");
	...
	it("should adjust ordinals after head delete", () => {
		const map = new LinkedHashMap<number, string>();
		map.set(1, "a");
		map.set(2, "b");
		map.set(3, "c");
	...
	it("should adjust ordinals after tail delete", () => {
		const map = new LinkedHashMap<number, string>();
		map.set(1, "a");
		map.set(2, "b");
		map.set(3, "c");
	...
	it("should delete the only thing in the list", () => {
		const map = new LinkedHashMap<string, string>();
		map.set("k1", "a");
		map.delete("k1");
		map.delete("k0");
